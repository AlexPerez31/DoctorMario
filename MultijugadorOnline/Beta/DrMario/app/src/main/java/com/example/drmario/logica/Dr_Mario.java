...
import static com.example.drmario.Level.virusLevel;
...
public class Dr_Mario {
    ...
    public int numnivel, virus, contarpuntaje = 0, numpuntaje , combo, numcom;
    public long puntaje;
    int nivel = virusLevel;
    ...
    public Dr_Mario() {
        System.out.println("acccccccccaaaaaaaaaaaaa " + virusLevel);
